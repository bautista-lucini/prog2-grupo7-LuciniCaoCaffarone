...
VALUES 
(default, 1, 'images/products/socks1.png', 'Comfort Cotton Socks - TM', 'Medias de algodón suave y transpirable, ideales para el uso diario.', current_timestamp, current_timestamp, NULL),
...
(default, 3, 'images/products/socks6.png', 'Cushioned Athletic Socks - TM', 'Medias atléticas con amortiguación para mayor comodidad durante el ejercicio.', current_timestamp, current_timestamp, NULL),
(default, 4, 'images/products/socks7.png', 'Merino Wool Hiking Socks - TM', 'Medias de lana merino para senderismo, mantienen los pies secos y calientes.', current_timestamp, current_timestamp, NULL),
(default, 4, 'images/products/socks8.png', 'No-Show Sneaker Socks - TM', 'Calcetines invisibles ideales para usar con zapatillas deportivas.', current_timestamp, current_timestamp, NULL),
(default, 5, 'images/products/socks9.png', 'Patterned Crew Socks - TM', 'Medias estampadas con diversos diseños para un toque de estilo.', current_timestamp, current_timestamp, NULL),
(default, 5, 'images/products/socks10.png', 'Diabetic Socks - TM', 'Medias especiales para diabéticos, sin costuras para evitar rozaduras.', current_timestamp, current_timestamp, NULL);

INSERT INTO comentarios (id, productos_id, usuario_id, texto_comentario, createdAt, updatedAt, deletedAt)
VALUES 
(default, 1, 1, '¡Estas medias de TM son increíblemente cómodas y duraderas! Me encanta cómo se sienten.', current_timestamp, current_timestamp, NULL),
